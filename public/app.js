// Daily Challenge App - Improved Version
class ChallengeApp {
    constructor() {
    ...
    addGoal() {
        ...
        this.renderCreateChallengeModal();
    }
    ...
    renderCreateChallengeModal() {
        ...
        return `
            <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50" id="challengeModal">
                <div class="bg-white rounded-xl p-6 w-full max-w-md animate-in slide-in-from-bottom-4">
                    ...
                    <div class="flex space-x-3 mt-6">
                        <button id="cancelChallengeBtn" class="flex-1 px-4 py-2 text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50">
                            Cancel
                        </button>
                        <button id="createChallengeBtn" class="flex-1 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">
                            Create
                        </button>
                    </div>
                </div>
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
                            <div class="p-6 border-b border-gray-200">
                                <div class="flex items-center justify-between">
                                    ...
                                    <button id="newChallengeBtn" class="flex items-center space-x-2 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
                                        <span>➕</span>
